package com.forttiori.multimodulereactivewebflux.exception;


import com.forttiori.multimodulereactivewebflux.exception.contracterror.ErrorObject;
import com.forttiori.multimodulereactivewebflux.exception.contracterror.ErrorResponse;
import com.forttiori.multimodulereactivewebflux.exception.trucknotfound.TruckNotFoundException;
...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(code = NOT_FOUND)
    public Mono<ErrorResponse> handlerNotFoundException(TruckNotFoundException error) {
        return Mono.just(ErrorResponse.builder()
                .timestamp(LocalDateTime.now().truncatedTo(ChronoUnit.SECONDS))
                .error(List.of(ErrorObject.builder()
                        .message(NOT_FOUND.name())
    ...
    @ResponseStatus(code = METHOD_NOT_ALLOWED)
    public Mono<ErrorResponse> handleWebExchangeBindException(WebExchangeBindException error) {
        return Mono.just(ErrorResponse.builder()
                .timestamp(LocalDateTime.now().truncatedTo(ChronoUnit.SECONDS))
                .error(List.of(ErrorObject.builder()
                        .message(METHOD_NOT_ALLOWED.name())
    ...
    @ResponseStatus(code = BAD_REQUEST)
    public Mono<ErrorResponse> handleServerWebInputException(ServerWebInputException error) {
        return Mono.just(ErrorResponse.builder()
                .timestamp(LocalDateTime.now().truncatedTo(ChronoUnit.SECONDS))
                .error(List.of(ErrorObject.builder()
                        .message(BAD_REQUEST.name())
